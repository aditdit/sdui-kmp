...
@class SharedButtonComponent, SharedButtonComponentCompanion, SharedContainerComponent, SharedContainerComponentCompanion, SharedKotlinArray<T>, SharedKotlinEnum<E>, SharedKotlinEnumCompanion, SharedKotlinNothing, SharedKotlinx_serialization_coreSerialKind, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_jsonClassDiscriminatorMode, SharedKotlinx_serialization_jsonJson, SharedKotlinx_serialization_jsonJsonConfiguration, SharedKotlinx_serialization_jsonJsonDefault, SharedKotlinx_serialization_jsonJsonElement, SharedKotlinx_serialization_jsonJsonElementCompanion, SharedSDUIComponent, SharedSDUIComponentCompanion, SharedTextComponent, SharedTextComponentCompanion;

@protocol SharedKotlinAnnotation, SharedKotlinComparable, SharedKotlinIterator, SharedKotlinKAnnotatedElement, SharedKotlinKClass, SharedKotlinKClassifier, SharedKotlinKDeclarationContainer, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreKSerializer, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerialFormat, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinx_serialization_coreStringFormat, SharedKotlinx_serialization_jsonJsonNamingStrategy, SharedPlatform;
...
*/
__attribute__((swift_name("SDUIComponent")))
@interface SharedSDUIComponent : SharedBase
@property (class, readonly, getter=companion) SharedSDUIComponentCompanion *companion __attribute__((swift_name("companion")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="button")
 *   kotlinx.serialization.Serializable
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ButtonComponent")))
@interface SharedButtonComponent : SharedSDUIComponent
- (instancetype)initWithLabel:(NSString *)label action:(NSString *)action __attribute__((swift_name("init(label:action:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedButtonComponentCompanion *companion __attribute__((swift_name("companion")));
- (SharedButtonComponent *)doCopyLabel:(NSString *)label action:(NSString *)action __attribute__((swift_name("doCopy(label:action:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ButtonComponent.Companion")))
@interface SharedButtonComponentCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedButtonComponentCompanion *shared __attribute__((swift_name("shared")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="container")
 *   kotlinx.serialization.Serializable
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ContainerComponent")))
@interface SharedContainerComponent : SharedSDUIComponent
- (instancetype)initWithChildren:(NSArray<SharedSDUIComponent *> *)children __attribute__((swift_name("init(children:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedContainerComponentCompanion *companion __attribute__((swift_name("companion")));
- (SharedContainerComponent *)doCopyChildren:(NSArray<SharedSDUIComponent *> *)children __attribute__((swift_name("doCopy(children:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedSDUIComponent *> *children __attribute__((swift_name("children")));
@property (readonly) SharedKotlinArray<SharedSDUIComponent *> *childrenArray __attribute__((swift_name("childrenArray")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ContainerComponent.Companion")))
@interface SharedContainerComponentCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedContainerComponentCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SDUIComponent.Companion")))
@interface SharedSDUIComponentCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedSDUIComponentCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SduiParser")))
@interface SharedSduiParser : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSString *)componentsToJsonComponents:(NSArray<SharedSDUIComponent *> *)components __attribute__((swift_name("componentsToJson(components:)")));
- (NSString *)getMockData __attribute__((swift_name("getMockData()")));
- (NSArray<SharedSDUIComponent *> *)parseJson:(NSString *)json __attribute__((swift_name("parse(json:)")));
- (SharedKotlinArray<SharedSDUIComponent *> *)parseAsArrayJson:(NSString *)json __attribute__((swift_name("parseAsArray(json:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TextComponent")))
@interface SharedTextComponent : SharedSDUIComponent
- (instancetype)initWithText:(NSString *)text fontSize:(SharedInt * _Nullable)fontSize color:(NSString * _Nullable)color __attribute__((swift_name("init(text:fontSize:color:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedTextComponentCompanion *companion __attribute__((swift_name("companion")));
- (SharedTextComponent *)doCopyText:(NSString *)text fontSize:(SharedInt * _Nullable)fontSize color:(NSString * _Nullable)color __attribute__((swift_name("doCopy(text:fontSize:color:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable color __attribute__((swift_name("color")));
@property (readonly) SharedInt * _Nullable fontSize __attribute__((swift_name("fontSize")));
@property (readonly) NSString *text __attribute__((swift_name("text")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TextComponent.Companion")))
@interface SharedTextComponentCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedTextComponentCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SDUIKt")))
@interface SharedSDUIKt : SharedBase
@property (class, readonly) SharedKotlinx_serialization_jsonJson *sduiJson __attribute__((swift_name("sduiJson")));
@end
...
@required
- (void)contextualKClass:(id<SharedKotlinKClass>)kClass provider:(id<SharedKotlinx_serialization_coreKSerializer> (^)(NSArray<id<SharedKotlinx_serialization_coreKSerializer>> *typeArgumentsSerializers))provider __attribute__((swift_name("contextual(kClass:provider:)")));
...
- (void)polymorphicDefaultSerializerBaseClass:(id<SharedKotlinKClass>)baseClass defaultSerializerProvider:(id<SharedKotlinx_serialization_coreSerializationStrategy> _Nullable (^)(id value))defaultSerializerProvider __attribute__((swift_name("polymorphicDefaultSerializer(baseClass:defaultSerializerProvider:)")));
@end
